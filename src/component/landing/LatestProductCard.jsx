  ...
  return (
    <div className="flex flex-col gap-[10px] p-2  w-[313px]  h-[225px]  hover:shadow-xl group relative  ">
      ...
      <div className="flex justify-center  items-center  w-full h-[180px]">
        <img
          className="p-[50px] w-[220px] h-[220px] object-cover transition-transform dursation-3000 group-hover:scale-90"
          src={img}
          alt="Product"
        />
      </div>
      <div className="flex justify-between items-center">
        <p className="font-[500] text-[14px] text-[#151875] underline decoration-[#EEEFFB] decoration-2 underline-offset-4 ">
          {name}{" "}
        </p>
